...
def predict():
    ...
    if request.method == 'POST':
        ...
        pred_dict = {1: 'Likely Loss-of-function', 2: 'Likely Gain-of-function', 3: 'Neutral', 4: 'Loss-of-function',
                     5: 'Likely Neutral', 6: 'Inconclusive', 7: 'Gain-of-function', 8: 'Likely Switch-of-function', 9: 'Switch-of-function'}
    return render_template('index.html', prediction=pred_dict[my_prediction[0]])
